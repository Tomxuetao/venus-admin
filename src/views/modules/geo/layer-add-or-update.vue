...
const dataRule = {
  ...
  datastore: [{ required: true, message: '请输入数据存储', trigger: 'blur' }],
  ...
  >
    ...
    >
      <el-form-item label="工作空间" prop="workspace">
        <el-select v-model="dataForm.workspace">
          <el-option
      ...
      <el-form-item label="图层名称" prop="name">
        <el-input v-model="dataForm.name" placeholder="图层名称"></el-input>
      </el-form-item>
